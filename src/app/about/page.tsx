            ...
            <div className="wiki-box-body" style={{ fontSize: '14px', lineHeight: '1.8' }}>
              ...
              <div style={{ marginLeft: '20px' }}>
                <p style={{ marginBottom: '8px' }}>
                  <strong style={{ color: 'var(--text-0)' }}>Discord:</strong> Join our{' '}
                  <a href="/discord" style={{ color: 'var(--link)' }}>Discord server</a> to discuss with other contributors.
                </p>
                <p style={{ marginBottom: '8px' }}>
                  <strong style={{ color: 'var(--text-0)' }}>Wiki Discussion:</strong> Use the comment sections on articles
