    ...
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="bg-dark-800/50 border border-dark-700 rounded-2xl p-8 text-center">
          <BookOpen className="w-12 h-12 text-crimson-500 mx-auto mb-4" />
          <h1 className="font-display text-2xl font-bold text-dark-50 mb-2">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-[#5865F2] hover:bg-[#4752C4] disabled:opacity-50 text-white font-medium rounded-lg transition-colors"
          >
