...
export const metadata: Metadata = {
  title: 'Demeniss',
  description: `Demeniss location guide for ${SITE_NAME} -- region information and points of interest.`,
};

export default function DemenissPage() {
  return (
    <>
      {/* PAGE HEADER */}
      <div className="page-hd">
        <div>
          <div className="page-hd-title">Demeniss</div>
      ...
      <div className="content-grid">
        <div>
          <div className="wiki-box">
            <div className="wiki-box-hd">Demeniss Region Guide</div>
            <div className="wiki-box-body" style={{ fontSize: '14px', lineHeight: '1.8', textAlign: 'center', padding: '40px 20px' }}>
              ...
              <p style={{ marginBottom: '24px' }}>
                This section has no articles yet. Be the first to contribute comprehensive Demeniss region information!
              </p>
          ...
          <div className="wiki-box">
            ...
            <div className="wiki-box-body" style={{ fontSize: '14px', lineHeight: '1.8' }}>
              <p style={{ marginBottom: '16px' }}>
                When creating content for Demeniss, consider including:
              </p>
              <ul style={{ marginLeft: '20px', marginBottom: '16px' }}>
                <li style={{ marginBottom: '8px' }}>Mountainous terrain and climate information</li>
                <li style={{ marginBottom: '8px' }}>Mountain passes and travel routes</li>
                <li style={{ marginBottom: '8px' }}>High-altitude settlements and outposts</li>
                <li style={{ marginBottom: '8px' }}>Mountain dungeons and cave systems</li>
                <li style={{ marginBottom: '8px' }}>Unique resources and materials</li>
                <li>Mountain-specific creatures and challenges</li>
              </ul>
              <p>
                Help other players explore the mountain regions of Crimson Desert!
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="right-sidebar">
          ...
          <div className="wiki-box">
            ...
            <div className="wiki-box-body">
              <Link href="/category/quests" className="sidebar-link">Mountain Quests</Link>
              <Link href="/category/bosses" className="sidebar-link">Mountain Bosses</Link>
              <Link href="/category/lore" className="sidebar-link">Mountain Lore</Link>
              <Link href="/category/items" className="sidebar-link">Mountain Resources</Link>
            </div>
          </div>
          ...
          <div className="wiki-box">
            ...
            <div className="wiki-box-body" style={{ fontSize: '12px', lineHeight: '1.6' }}>
              <p style={{ marginBottom: '8px' }}>
                Document Demeniss's mountain terrain!
              </p>
