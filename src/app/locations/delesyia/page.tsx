...
export const metadata: Metadata = {
  title: 'Delesyia',
  description: `Delesyia location guide for ${SITE_NAME} -- region information and points of interest.`,
};

export default function DelesyiaPage() {
  return (
    <>
      {/* PAGE HEADER */}
      <div className="page-hd">
        <div>
          <div className="page-hd-title">Delesyia</div>
      ...
      <div className="content-grid">
        <div>
          <div className="wiki-box">
            <div className="wiki-box-hd">Delesyia Region Guide</div>
            <div className="wiki-box-body" style={{ fontSize: '14px', lineHeight: '1.8', textAlign: 'center', padding: '40px 20px' }}>
              ...
              <p style={{ marginBottom: '24px' }}>
                This section has no articles yet. Be the first to contribute comprehensive Delesyia region information!
              </p>
          ...
          <div className="wiki-box">
            ...
            <div className="wiki-box-body" style={{ fontSize: '14px', lineHeight: '1.8' }}>
              <p style={{ marginBottom: '16px' }}>
                When creating content for Delesyia, consider including:
              </p>
              <ul style={{ marginLeft: '20px', marginBottom: '16px' }}>
                <li style={{ marginBottom: '8px' }}>Coastal areas and beach locations</li>
                <li style={{ marginBottom: '8px' }}>Port cities and maritime trade</li>
                <li style={{ marginBottom: '8px' }}>Islands and offshore locations</li>
                <li style={{ marginBottom: '8px' }}>Underwater areas and sunken ruins</li>
                <li style={{ marginBottom: '8px' }}>Marine resources and fishing spots</li>
                <li>Coastal dungeons and sea caves</li>
              </ul>
              <p>
                Help other players explore the coastal regions of Crimson Desert!
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="right-sidebar">
          ...
          <div className="wiki-box">
            ...
            <div className="wiki-box-body">
              <Link href="/category/quests" className="sidebar-link">Coastal Quests</Link>
              <Link href="/category/bosses" className="sidebar-link">Sea Bosses</Link>
              <Link href="/category/lore" className="sidebar-link">Maritime Lore</Link>
              <Link href="/category/items" className="sidebar-link">Sea Resources</Link>
            </div>
          </div>
          ...
          <div className="wiki-box">
            ...
            <div className="wiki-box-body" style={{ fontSize: '12px', lineHeight: '1.6' }}>
              <p style={{ marginBottom: '8px' }}>
                Document Delesyia's coastal regions!
              </p>
