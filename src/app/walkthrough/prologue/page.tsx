...
export const metadata: Metadata = {
  title: 'Prologue',
  description: `Prologue walkthrough for ${SITE_NAME} -- story guide and quest help.`,
};
  ...
  return (
    <>
      ...
      <div className="page-hd">
        <div>
          <div className="page-hd-title">Prologue</div>
      ...
      <div className="content-grid">
        <div>
          <div className="wiki-box">
            <div className="wiki-box-hd">Prologue Walkthrough</div>
            <div className="wiki-box-body" style={{ fontSize: '14px', lineHeight: '1.8', textAlign: 'center', padding: '40px 20px' }}>
              ...
              <p style={{ marginBottom: '24px' }}>
                This section has no articles yet. Be the first to contribute comprehensive prologue walkthrough content!
              </p>
          ...
          <div className="wiki-box">
            ...
            <div className="wiki-box-body" style={{ fontSize: '14px', lineHeight: '1.8' }}>
              ...
              <ul style={{ marginLeft: '20px', marginBottom: '16px' }}>
                <li style={{ marginBottom: '8px' }}>Step-by-step prologue quest progression</li>
                <li style={{ marginBottom: '8px' }}>Character introduction and background</li>
                <li style={{ marginBottom: '8px' }}>Key story events and decisions</li>
                <li style={{ marginBottom: '8px' }}>Tutorial explanations and tips</li>
                <li style={{ marginBottom: '8px' }}>Prologue-specific mechanics and features</li>
                <li>Preparation for main game content</li>
              </ul>
              <p>
                Help other players navigate the beginning of their Crimson Desert journey!
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="wiki-box">
            ...
            <div className="wiki-box-body" style={{ fontSize: '12px', lineHeight: '1.6' }}>
              <p style={{ marginBottom: '8px' }}>
                Help build the complete prologue guide!
              </p>
