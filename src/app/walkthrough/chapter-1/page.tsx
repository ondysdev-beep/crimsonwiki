...
export const metadata: Metadata = {
  title: 'Chapter 1',
  description: `Chapter 1 walkthrough for ${SITE_NAME} -- story guide and quest help.`,
};
  ...
  return (
    <>
      ...
      <div className="page-hd">
        <div>
          <div className="page-hd-title">Chapter 1</div>
      ...
      <div className="content-grid">
        <div>
          <div className="wiki-box">
            <div className="wiki-box-hd">Chapter 1 Walkthrough</div>
            <div className="wiki-box-body" style={{ fontSize: '14px', lineHeight: '1.8', textAlign: 'center', padding: '40px 20px' }}>
              ...
              <p style={{ marginBottom: '24px' }}>
                This section has no articles yet. Be the first to contribute comprehensive Chapter 1 walkthrough content!
              </p>
          ...
          <div className="wiki-box">
            ...
            <div className="wiki-box-body" style={{ fontSize: '14px', lineHeight: '1.8' }}>
              ...
              <ul style={{ marginLeft: '20px', marginBottom: '16px' }}>
                <li style={{ marginBottom: '8px' }}>Chapter 1 main quest progression</li>
                <li style={{ marginBottom: '8px' }}>Key story events and character developments</li>
                <li style={{ marginBottom: '8px' }}>Important locations and areas introduced</li>
                <li style={{ marginBottom: '8px' }}>New mechanics and gameplay features</li>
                <li style={{ marginBottom: '8px' }}>Boss encounters and strategies</li>
                <li>Side quests and optional content</li>
              </ul>
              <p>
                Help other players navigate through Chapter 1 of Crimson Desert!
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="wiki-box">
            ...
            <div className="wiki-box-body" style={{ fontSize: '12px', lineHeight: '1.6' }}>
              <p style={{ marginBottom: '8px' }}>
                Help build the complete Chapter 1 guide!
              </p>
