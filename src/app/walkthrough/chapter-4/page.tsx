...
export const metadata: Metadata = {
  title: 'Chapter 4',
  description: `Chapter 4 walkthrough for ${SITE_NAME} -- story guide and quest help.`,
};
  ...
  return (
    <>
      ...
      <div className="page-hd">
        <div>
          <div className="page-hd-title">Chapter 4</div>
      ...
      <div className="content-grid">
        <div>
          <div className="wiki-box">
            <div className="wiki-box-hd">Chapter 4 Walkthrough</div>
            <div className="wiki-box-body" style={{ fontSize: '14px', lineHeight: '1.8', textAlign: 'center', padding: '40px 20px' }}>
              ...
              <p style={{ marginBottom: '24px' }}>
                This section has no articles yet. Be the first to contribute comprehensive Chapter 4 walkthrough content!
              </p>
          ...
          <div className="wiki-box">
            ...
            <div className="wiki-box-body" style={{ fontSize: '14px', lineHeight: '1.8' }}>
              ...
              <ul style={{ marginLeft: '20px', marginBottom: '16px' }}>
                <li style={{ marginBottom: '8px' }}>Chapter 4 main quest progression</li>
                <li style={{ marginBottom: '8px' }}>Endgame story and resolution</li>
                <li style={{ marginBottom: '8px' }}>Final boss encounters and strategies</li>
                <li style={{ marginBottom: '8px' }}>Post-game content and activities</li>
                <li style={{ marginBottom: '8px' }}>New Game+ and replayability</li>
                <li>Achievement and trophy guides</li>
              </ul>
              <p>
                Help other players complete Chapter 4 and master Crimson Desert!
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="wiki-box">
            ...
            <div className="wiki-box-body" style={{ fontSize: '12px', lineHeight: '1.6' }}>
              <p style={{ marginBottom: '8px' }}>
                Help build the complete Chapter 4 guide!
              </p>
